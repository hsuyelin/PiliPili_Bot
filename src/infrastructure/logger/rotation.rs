...
/// 
/// The rotation strategy determines when a new log file is created
/// and the old one is archived. This helps manage log file sizes
/// and organize logs by time periods.
